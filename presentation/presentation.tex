...
\frame{
  ...
  \begin{figure}
  \includegraphics[width=0.4\textwidth]{InitialUI.png}
  \end{figure}
  \begin{itemize}
  \item<1-> Team quickly decided that a UI prototype should be implemented
  early on in the process.
  \item<2-> Allows us to see how practical design choices are and keep up with
  any changes in the parsing/algorithmic side of development.
  \item<3-> Future UI will likely be built on these initial foundations. This
