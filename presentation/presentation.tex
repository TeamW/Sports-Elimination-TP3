...
\frame{
  ...
  \item<3-> Currently generates initial graph and begins to work out how much
  more flow can be passed from the source to the sink.
  \item<4-> Passing flow through the graph will allow us to determine if the
  given team X can win the league.
  ...
  \item<6-> By definition, everything leaving the source has to arrive at the
  sink.
  \end{itemize}
}
\frame{
