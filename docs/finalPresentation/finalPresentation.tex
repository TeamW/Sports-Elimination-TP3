...
\frame{
  ...
  \item<2-> Update the elimination status on start-up, as well as on week
  changes.
...
\frame {
  ...
  \begin{itemize}
  \item<2-> An extension of the desktop application.
  \item<2-> Contains a subset of most important functionality of
  desktop application.
  \item<3-> Numerous extensions of web application part of future work.
  \end{itemize}
}
\frame {
...
\frame {
  ...
  \item blah
  \item blah
  \item We would now like to invite questions from the panel. Thank you for
  listening.
  \end{itemize}
}
\end{document}
