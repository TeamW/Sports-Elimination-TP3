...
Overall User Evaluation was very successful. Gained a diverse range of quality
feedback from test subjects. Discovered Bugs, Usability Issues and Design Flaws
- Highlight the value of User Testing.
\begin{itemize}
