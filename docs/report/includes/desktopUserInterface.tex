...
drop down boxes. These components all have event listeners that set the data accordingly
and call a shared function that updates and redraws the table model.
