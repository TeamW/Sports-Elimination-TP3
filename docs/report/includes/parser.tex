...
Regardless these were the main reasons behind the teams decision to
...
As can be seen in the screenshot above this is a sample of data from
...
% I've added this in for consistency of report.
\IncMargin{2em}
\begin{algorithm}
  \SetAlgoLined
